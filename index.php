...
<head>
<title>Speed Racing - Rent A Car Dealership</title>
...
<!-- HEADER -->
	<div id="header">
		...
		<div class="row-3">
			<div class="inside">
				<h2>Rent online and get <b>10% Discount</b> </h2>
						...
						<div class="right-bot-corner">
							<div class="left-bot-corner">
								<div class="inner">
									<div class="box1">
										<div class="inner">
											<h4><b>Speed</b> Racing</h4>
											<p>If you are looking for extreme, try speed racing that gives you a feeling of freedom and danger. Learn more about it from this site. <a href="#"><img src="images/arrow.gif" alt="" /></a></p>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="right-bot-corner">
							<div class="left-bot-corner">
								<div class="inner">
									<div class="box1">
										<div class="inner">
											<h4><b>Car</b> Concepts</h4>
											<p>Learn more about the latest car con-	cepts from this sample article. Lorem ipsum dolor sit amet, consectetur adipisicing elitimod. <a href="#"><img src="images/arrow.gif" alt="" /></a></p>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="box3">
						<div class="right-bot-corner">
							<div class="left-bot-corner">
								<div class="inner">
								<?php
									include ("snippets/loginForm.html");
								?>								
								</div>
							</div>
						</div>
